                 ...
                 <form  id="myUpload">
                    <div class="form-row" style="padding-bottom: 1rem;">
                       <div class="col-sm-2" style="padding-top: .3rem;">
                          <label style="color: #171dc2;"><b>Item Pic</b></label>
                        </div>
                       <div class="col-sm-6" >
                  ...
                  <center><button type="button" class="btn btn-primary btn-md" style="width:285px;" onclick="uploadFile()"><i class="fas fa-plus"></i> Add this Item</button></center>
          </div>
        </div>
      </div>
    </div>
