                    ...
                    <div class="form-row">       
                        <div class="col-md-5">
                           <div class="form-group">
                              <input type="text" class="form-control" id="addquantity" placeholder="Input Quantity">
                              <span class="bmd-help text-primary">Input receipt number.</span>
                           </div>
                        </div>
                        <div class="col-md-3">
                          <button class="btn btn-primary btn-sm" onclick="plusItem('<%=quantity%>','<%=original_item_id%>')">Add</button>
                        </div>  
                        <div class="col-md-3">
